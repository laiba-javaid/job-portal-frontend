                        ...
                        <div className="flex items-center justify-center">
                           ...
                           <div className="text-center">
                              ...
                              <p className="text-emerald-100 mt-1">
                                 Modify your job details to attract the right candidates
                              </p>
                           </div>
                        </div>
         ...
         <div className="hidden lg:block absolute bottom-8 right-8 max-w-sm">
            <div className="bg-white rounded-2xl shadow-xl p-6 border border-emerald-100">
               <div className="flex items-start space-x-3">
                  ...
                  <div>
                     <h3 className="text-sm font-semibold text-gray-800">Update Tips</h3>
                     <ul className="text-xs text-gray-600 mt-2 space-y-1">
                        <li>• Review all fields for accuracy</li>
                        <li>• Update salary if market rates changed</li>
                        <li>• Refresh the job description</li>
                        <li>• Extend deadline if needed</li>
                        <li>• Consider current hiring needs</li>
                     </ul>
                  </div>
               </div>
            </div>
